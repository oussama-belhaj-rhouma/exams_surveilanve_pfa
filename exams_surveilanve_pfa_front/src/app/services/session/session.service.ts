...
export class SessionService {
 ...
 public getSessions(): Observable<Session[]> {
  ...
  public deleteSession(id: number): Observable<void> {
    return this.http.delete<void>(`http://localhost:8080/Session/delete/${id}`, {
      withCredentials: true,
    });
  }

  public addCalendrier(affectationId: number , CalendrierId: number): Observable<void>{
    return this.http.post<void>(`http://localhost:8080/affectation/addCalendrier/${affectationId}/${CalendrierId}`,null)
 }
